...
<view class="cu-list grid col-3 no-border margin-top">
			<view>
				...
				<view>
					<button class=" cu-btn bg-img lg text-white"style="background-image: url(../../../static/me_diary.png)">1</button>
					<view class="text-grey">心情日记</text></view>
					</view>
					<view>
						<button class=" cu-btn bg-img lg text-white"style="background-image: url(../../../static/me_summary.png)"></button>
						<view class="text-grey">每周总结</text></view>
						</view>
						<view>
							<button class=" cu-btn bg-img lg text-white"style="background-image: url(../../../static/me_team.png)"></button>
							<view class="text-grey">我的小组</text></view>
							</view>
							<view>
								<button class=" cu-btn bg-img lg text-white"style="background-image: url(../../../static/me_gugu.png)"></button>
								<view class="text-grey">我的成就</text></view>
								</view>
								<view>
									<button class=" cu-btn bg-img lg text-white"style="background-image: url(../../../static/me_set.png)"></button>
